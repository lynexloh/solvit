		...
		<tbody>
				  ...
				  $tech = 'User';
				   $tech1 = 'user';
                     ...
                     $query = "SELECT * FROM user where type LIKE '$tech' or type LIKE '$tech1'";
				...
				<td><?php echo $key['occupation'];?></td>

				<td><?php echo $key['experience'];?></td>
									<td><?php echo $key['address'];?></td>
				<td><?php echo $key['points'];?></td>
          	<td><a class='btn btn-info btn-xs' href="upgrade.php?ids=<?php echo $key['user_ID'];?>"><span class="glyphicon glyphicon-plus"></span> Upgrade</a> </td>
