...
include_once 'connection.php';
   ...
   if ($_SESSION['checkLogin'] != '1') {
	...
	$stmt3 = $MySQLi_CON->prepare("SELECT * from user WHERE user_ID LIKE $id"); 
	$stmt3->execute(); 
	...
	<div class ="side">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- Optionally, you can add icons to the links -->
        	<li class ="<?php echo "$starter";?>"><a href="starter.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
...
<li class ="<?php echo "$solve";?>">
          ...
          <ul class="treeview-menu">
            <li class ="<?php echo "$solvit";?>"><a href="solvit.php"><i class="fa fa-circle-o"></i>Problems</a></li>
            <li class ="<?php echo "$solvit2";?>"><a href="solvit2.php"><i class="fa fa-circle-o"></i>Questions</a></li>	
          </ul>
        </li>
		<li class ="<?php echo "$reward";?>"><a href="reward.php"><i class="fa fa-gift"></i> <span>Reward</span></a></li>
 ...
 <ul class="sidebar-menu">
		...
		<li class ="<?php echo "$tech";?>">
		  ...
		  <li class ="<?php echo "$rewards";?>"><a href="createreward.php"><i class="fa fa-gift"></i> <span>Reward</span></a></li>		
