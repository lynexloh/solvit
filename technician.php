              ...
              <section class="content">
                ...
                <div class="row">
                  <div class="create-user-box">
                    ...
                    <div class="create-user-box-body">
                      <p class="login-box-msg">Create Technician</p>

                      <form action="createTech.php" name="registrationform" method="post">
                        ...
                        <div class="form-group has-feedback">
						  ...
						  <div class="form-group has-feedback">
                          <input type="email" class="form-control" name="paypal" placeholder="Paypal Email" required>
                          <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                        </div>
						  <div class="form-group has-feedback">
                          <input type="text" class="form-control" name="chat" placeholder="Chat ID">
                          <span class="glyphicon glyphicon-user form-control-feedback"></span>
                        </div>
                        <!-- /.col -->
